...
export class MigrationName1725069564253 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`Messages\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`content\` varchar(255) NOT NULL, \`isRead\` tinyint NOT NULL DEFAULT 0, \`ownerId\` varchar(36) NULL, \`groupChatId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`Columns\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`name\` varchar(255) NOT NULL, \`totalTask\` int NOT NULL DEFAULT '0', \`statusCode\` varchar(255) NOT NULL, \`index\` int NOT NULL, \`teamId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`SubTasks\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`name\` varchar(255) NOT NULL, \`taskId\` varchar(255) NOT NULL, \`isChecked\` tinyint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`TaskComment\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`content\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`taskId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`TaskFile\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`fileLink\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`taskId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`TaskHistory\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`title\` varchar(255) NOT NULL, \`description\` varchar(10000) NOT NULL, \`taskId\` varchar(255) NOT NULL, \`ownerId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`Tasks\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`title\` varchar(255) NOT NULL, \`description\` varchar(10000) NOT NULL, \`expireDate\` datetime NOT NULL, \`priority\` varchar(255) NOT NULL DEFAULT 'MEDIUM', \`type\` varchar(255) NOT NULL DEFAULT 'TASK', \`status\` varchar(255) NOT NULL DEFAULT 'TO_ASSIGN', \`fileLink\` varchar(255) NOT NULL DEFAULT '', \`cmdCheckOutBranch\` varchar(255) NOT NULL DEFAULT '', \`cmdCommit\` varchar(255) NOT NULL DEFAULT '', \`sourceCodeLink\` varchar(255) NOT NULL DEFAULT '', \`code\` varchar(255) NOT NULL, \`index\` int NOT NULL, \`columnId\` varchar(255) NOT NULL, \`totalComment\` int NOT NULL, \`totalTaskFile\` int NOT NULL, \`totalSubTask\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`group_chats_lst_member_users\` (\`groupChatsId\` varchar(36) NOT NULL, \`usersId\` varchar(36) NOT NULL, INDEX \`IDX_dbc50c72ec9266ae6915dec3ef\` (\`groupChatsId\`), INDEX \`IDX_471b458ddb62fa0893836384e7\` (\`usersId\`), PRIMARY KEY (\`groupChatsId\`, \`usersId\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`teams_members_users\` (\`teamsId\` varchar(36) NOT NULL, \`usersId\` varchar(36) NOT NULL, INDEX \`IDX_7669600fb5620861e64df6be12\` (\`teamsId\`), INDEX \`IDX_309874039d297b30d077d16ae7\` (\`usersId\`), PRIMARY KEY (\`teamsId\`, \`usersId\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`tasks_lst_person_in_charge_users\` (\`tasksId\` varchar(36) NOT NULL, \`usersId\` varchar(36) NOT NULL, INDEX \`IDX_0f475a899d5df704673af6babd\` (\`tasksId\`), INDEX \`IDX_29d524b35d36a3fe49dbe1659c\` (\`usersId\`), PRIMARY KEY (\`tasksId\`, \`usersId\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `ALTER TABLE \`Messages\` ADD CONSTRAINT \`FK_b12fd5b5c9a4672bb2a88ffbb75\` FOREIGN KEY (\`ownerId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`Messages\` ADD CONSTRAINT \`FK_dfc9935de6cca24502aac8746da\` FOREIGN KEY (\`groupChatId\`) REFERENCES \`GroupChats\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`SubTasks\` ADD CONSTRAINT \`FK_a4877d69c91fc8e442d28aec28e\` FOREIGN KEY (\`taskId\`) REFERENCES \`Tasks\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskComment\` ADD CONSTRAINT \`FK_5239101dd6905b80bd59e2d412a\` FOREIGN KEY (\`userId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskComment\` ADD CONSTRAINT \`FK_44b50c052585d001e0a5cf90baf\` FOREIGN KEY (\`taskId\`) REFERENCES \`Tasks\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskFile\` ADD CONSTRAINT \`FK_b0be7cb888917c86795747ca11f\` FOREIGN KEY (\`taskId\`) REFERENCES \`Tasks\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskHistory\` ADD CONSTRAINT \`FK_0d42c840a529301aa32e9ba7765\` FOREIGN KEY (\`taskId\`) REFERENCES \`Tasks\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskHistory\` ADD CONSTRAINT \`FK_9f0a0661fa16f394389f26d2b81\` FOREIGN KEY (\`ownerId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`Tasks\` ADD CONSTRAINT \`FK_150fedd2a3f5f9a9ad2b4612387\` FOREIGN KEY (\`columnId\`) REFERENCES \`Columns\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`Users\` ADD CONSTRAINT \`FK_b2c7e0202f52d3ff6cc4c505813\` FOREIGN KEY (\`notificationsId\`) REFERENCES \`Notifications\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`group_chats_lst_member_users\` ADD CONSTRAINT \`FK_471b458ddb62fa0893836384e7f\` FOREIGN KEY (\`usersId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`teams_members_users\` ADD CONSTRAINT \`FK_7669600fb5620861e64df6be125\` FOREIGN KEY (\`teamsId\`) REFERENCES \`Teams\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE \`teams_members_users\` ADD CONSTRAINT \`FK_309874039d297b30d077d16ae76\` FOREIGN KEY (\`usersId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`tasks_lst_person_in_charge_users\` ADD CONSTRAINT \`FK_0f475a899d5df704673af6babdb\` FOREIGN KEY (\`tasksId\`) REFERENCES \`Tasks\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE \`tasks_lst_person_in_charge_users\` ADD CONSTRAINT \`FK_29d524b35d36a3fe49dbe1659cb\` FOREIGN KEY (\`usersId\`) REFERENCES \`Users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`tasks_lst_person_in_charge_users\` DROP FOREIGN KEY \`FK_29d524b35d36a3fe49dbe1659cb\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`tasks_lst_person_in_charge_users\` DROP FOREIGN KEY \`FK_0f475a899d5df704673af6babdb\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`teams_members_users\` DROP FOREIGN KEY \`FK_309874039d297b30d077d16ae76\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`teams_members_users\` DROP FOREIGN KEY \`FK_7669600fb5620861e64df6be125\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`group_chats_lst_member_users\` DROP FOREIGN KEY \`FK_471b458ddb62fa0893836384e7f\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`Users\` DROP FOREIGN KEY \`FK_b2c7e0202f52d3ff6cc4c505813\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`Tasks\` DROP FOREIGN KEY \`FK_150fedd2a3f5f9a9ad2b4612387\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskHistory\` DROP FOREIGN KEY \`FK_9f0a0661fa16f394389f26d2b81\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskHistory\` DROP FOREIGN KEY \`FK_0d42c840a529301aa32e9ba7765\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskFile\` DROP FOREIGN KEY \`FK_b0be7cb888917c86795747ca11f\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskComment\` DROP FOREIGN KEY \`FK_44b50c052585d001e0a5cf90baf\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`TaskComment\` DROP FOREIGN KEY \`FK_5239101dd6905b80bd59e2d412a\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`SubTasks\` DROP FOREIGN KEY \`FK_a4877d69c91fc8e442d28aec28e\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`Messages\` DROP FOREIGN KEY \`FK_dfc9935de6cca24502aac8746da\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`Messages\` DROP FOREIGN KEY \`FK_b12fd5b5c9a4672bb2a88ffbb75\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_29d524b35d36a3fe49dbe1659c\` ON \`tasks_lst_person_in_charge_users\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_0f475a899d5df704673af6babd\` ON \`tasks_lst_person_in_charge_users\``,
    );
    await queryRunner.query(`DROP TABLE \`tasks_lst_person_in_charge_users\``);
    await queryRunner.query(
      `DROP INDEX \`IDX_309874039d297b30d077d16ae7\` ON \`teams_members_users\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_7669600fb5620861e64df6be12\` ON \`teams_members_users\``,
    );
    await queryRunner.query(`DROP TABLE \`teams_members_users\``);
    await queryRunner.query(
      `DROP INDEX \`IDX_471b458ddb62fa0893836384e7\` ON \`group_chats_lst_member_users\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_dbc50c72ec9266ae6915dec3ef\` ON \`group_chats_lst_member_users\``,
    );
