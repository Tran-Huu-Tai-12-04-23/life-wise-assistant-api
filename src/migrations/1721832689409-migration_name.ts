...
export class MigrationName1721832689409 implements MigrationInterface {
    name = 'MigrationName1721832689409'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`Devices\` (\`id\` varchar(36) NOT NULL, \`type\` varchar(255) NOT NULL, \`status\` tinyint NOT NULL DEFAULT 0, \`socketId\` varchar(255) NOT NULL, \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_a4e60bb519dfcf5e9b62a56206\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Messages\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`content\` varchar(255) NOT NULL, \`isRead\` tinyint NOT NULL DEFAULT 0, \`userId\` varchar(36) NULL, \`groupChatId\` varchar(36) NULL, UNIQUE INDEX \`REL_222f23e21991d82f16ef0d44d8\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`GroupChats\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`type\` varchar(255) NOT NULL, \`status\` tinyint NOT NULL DEFAULT 0, \`socketId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Users\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdBy\` varchar(36) NULL, \`createdByName\` varchar(50) NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updatedBy\` varchar(36) NULL, \`deleteBy\` varchar(36) NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, \`username\` varchar(500) NOT NULL, \`password\` varchar(500) NOT NULL, \`avatar\` varchar(255) NOT NULL, \`verifyAt\` datetime NOT NULL, \`isActive\` tinyint NOT NULL, \`role\` varchar(255) NOT NULL DEFAULT 'MEMBER', \`notificationsId\` varchar(36) NULL, \`deviceId\` varchar(36) NULL, UNIQUE INDEX \`REL_1e5b1f4b0e11ca474dd791d5bb\` (\`deviceId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Devices\` ADD CONSTRAINT \`FK_a4e60bb519dfcf5e9b62a562064\` FOREIGN KEY (\`userId\`) REFERENCES \`Users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`Users\` ADD CONSTRAINT \`FK_1e5b1f4b0e11ca474dd791d5bb7\` FOREIGN KEY (\`deviceId\`) REFERENCES \`Devices\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Users\` DROP FOREIGN KEY \`FK_1e5b1f4b0e11ca474dd791d5bb7\``);
        ...
        await queryRunner.query(`ALTER TABLE \`Messages\` DROP FOREIGN KEY \`FK_222f23e21991d82f16ef0d44d87\``);
        await queryRunner.query(`ALTER TABLE \`Devices\` DROP FOREIGN KEY \`FK_a4e60bb519dfcf5e9b62a562064\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_1e5b1f4b0e11ca474dd791d5bb\` ON \`Users\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_222f23e21991d82f16ef0d44d8\` ON \`Messages\``);
        await queryRunner.query(`DROP TABLE \`Messages\``);
        await queryRunner.query(`DROP INDEX \`REL_a4e60bb519dfcf5e9b62a56206\` ON \`Devices\``);
